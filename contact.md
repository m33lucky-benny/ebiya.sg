...
<form id="contact-form" action="https://formspree.io/f/mykgqeew" method="POST" class="contact-form">
...
<div class="social-section">
  ...
  <div class="social-links">
    ...
    <a href="{{ site.tiktok_url }}" target="_blank" rel="noopener noreferrer" class="social-link tiktok">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    <a href="{{ site.whatsapp_url }}" target="_blank" rel="noopener noreferrer" class="social-link whatsapp">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
...
.contact-intro {
  margin-bottom: 2rem;
  color: #e0e0e0; /* Light gray for dark BG */
  line-height: 1.6;
}
...
.required {
  color: #ff6b6b; /* Lighter red for required */
}
...
.form-group textarea:focus {
  outline: none;
  border-color: #4da6ff; /* Bright blue focus */
...
#form-status.success {
  background-color: #2d5a3a; /* Dark green */
...
#form-status.error {
  background-color: #5a2d32; /* Dark red */
...
(function() {
  ...
  form.addEventListener('submit', function(e) {
    ...
    .catch(error => {
      ...
      statusDiv.textContent = 'Oops! There was a problem submitting your form. Please try again or contact us directly via social media.';
      statusDiv.style.display = 'block';
    })
    .finally(() => {
