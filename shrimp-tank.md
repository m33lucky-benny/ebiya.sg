...
<div class="page-container">
  ...
  <p class="hero-subtitle">Step-by-step guide to building a stable Caridina (Taiwan bee) tank for Singapore conditions.</p>
  ...
  <div class="tank-cards">
    <div class="tank-card" data-size="45">
      ...
      <ul>
        ...
        <li>More sensitive to parameter swings</li>
        <li><strong>Start:</strong> 12–18 Caridina</li>
        <li><strong>Max (advanced):</strong> 20–25 Caridina</li>
      </ul>
    </div>
    ...
    <div class="tank-card" data-size="60">
      ...
      <ul>
        ...
        <li><strong>Start:</strong> 20–30 Caridina</li>
        <li><strong>Max (advanced):</strong> 35–45 Caridina</li>
      </ul>
    </div>
  </div>
  ...
  <div id="build" class="build-section">
    ...
    <div class="param-box" aria-label="Recommended water parameters for Caridina">
      ...
      <p style="margin:.75rem 0 0; color:rgba(255,255,255,.75); font-size:.95rem; line-height:1.4;">
        Tip: In Singapore, prioritize temperature stability and avoid sudden water changes that shift pH/TDS too fast.
      </p>
    </div>
    ...
    <div id="membership" class="membership-cta">
      ...
      <p>Join <strong>ebiyaSG Membership</strong> for a full setup checklist, parameter tracker, and support before something goes wrong.</p>
      <a href="https://www.ebiya.sg/membership/">Join Now</a>
    </div>
  </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  cards.forEach(card => {
    card.addEventListener('click', () => {
      ...
      if (size === "45") {
        soil.textContent = "Active shrimp soil: ~2.5–3 L. Thin slope. Do not rinse. Keep it simple to reduce trapped waste in smaller volumes.";
      ...
      if (size === "60") {
        soil.textContent = "Active shrimp soil: ~6–8 L for longer buffering. Do not rinse. Slightly deeper bed supports stable pH over time.";
